...
func RedisMarshalWithGob(data interface{}) *bytes.Buffer {
	...
	if err != nil {
		ccgo.LogError("RedisMarshalWithGob:", err)
		return nil
	}
	return buf
}
...
func RedisUnmarshalWithGob(data []byte, reply interface{}) {
	...
	if err != nil {
		ccgo.LogError("RedisUnmarshalWithGob:", err)
	}
}
...
func RedisMarshal(data interface{}) []byte {
	...
	if err != nil {
		ccgo.LogError("RedisMarshal:", err)
		return nil
	}
...
func RedisUnmarshal(data []byte, reply interface{}) {
	...
	if err != nil {
		ccgo.LogError("RedisUnmarshal:", err)
	}
}
...
func newRedisProxy(conf RedisConfig) *Redis {
	...
	ccgo.LogInfo("newRedisProxy connected to", conf)
	return r
}
